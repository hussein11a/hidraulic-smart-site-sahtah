...
const FloatingNavigation: React.FC<FloatingNavigationProps> = ({
  ...
  const WhatsAppIcon = ({ className = "h-14 w-14" }: { className?: string }) => (
    ...
    <>
      ...
      <div className="fixed bottom-8 right-8 flex flex-col gap-6 z-50">
        ...
        <div className={`transition-all duration-1000 transform ${
          ...
          <div className="flex flex-col gap-6">
            ...
            <Button
              ...
              className={`group relative w-20 h-20 rounded-2xl shadow-2xl transition-all duration-700 hover:scale-125 border-4 border-white/40 backdrop-blur-xl overflow-hidden ${
                isDarkMode 
              ...
              } ${activeButton === 'home' ? 'scale-125 rotate-6 shadow-3xl' : ''} ${buttonAnimations.home ? 'animate-bounce' : ''}`}
            >
              ...
              <div className="absolute inset-0 bg-blue-400/20 animate-ping rounded-2xl opacity-0 group-hover:opacity-60"></div>
              ...
              <Home className="h-9 w-9 group-hover:scale-125 group-hover:rotate-6 transition-all duration-500 relative z-10 drop-shadow-xl" />
              
              {/* Professional Glow */}
              <div className="absolute -inset-6 bg-gradient-radial from-blue-400/40 via-purple-300/30 to-transparent rounded-2xl blur-2xl opacity-60 group-hover:opacity-90 transition-opacity duration-700"></div>
            ...
            <Button
              ...
              } ${activeButton === 'services' ? 'scale-125 -rotate-6 shadow-3xl' : ''} ${buttonAnimations.services ? 'animate-pulse' : ''}`}
            >
              ...
              <div className="absolute inset-0 bg-emerald-400/20 animate-ping rounded-2xl opacity-0 group-hover:opacity-60"></div>
              ...
              <Shield className="h-9 w-9 group-hover:scale-125 group-hover:-rotate-6 transition-all duration-500 relative z-10 drop-shadow-xl" />
              <div className="absolute -inset-6 bg-gradient-radial from-emerald-400/40 via-teal-300/30 to-transparent rounded-2xl blur-2xl opacity-60 group-hover:opacity-90 transition-opacity duration-700"></div>
              
              <div className="absolute -top-2 -left-2 w-6 h-6 bg-yellow-500 rounded-full flex items-center justify-center border-2 border-white animate-pulse">
            ...
            <Button
              ...
              } ${activeButton === 'contact' ? 'scale-125 rotate-6 shadow-3xl' : ''} ${buttonAnimations.contact ? 'animate-bounce' : ''}`}
            >
              ...
              <div className="absolute inset-0 bg-amber-400/20 animate-ping rounded-2xl opacity-0 group-hover:opacity-60"></div>
              ...
              <Mail className="h-9 w-9 group-hover:scale-125 group-hover:rotate-6 transition-all duration-500 relative z-10 drop-shadow-xl" />
              <div className="absolute -inset-6 bg-gradient-radial from-amber-400/40 via-yellow-300/30 to-transparent rounded-2xl blur-2xl opacity-60 group-hover:opacity-90 transition-opacity duration-700"></div>
        ...
        <Button
          ...
          className={`group relative w-24 h-24 rounded-full shadow-3xl transition-all duration-1000 hover:scale-125 border-6 border-white/50 backdrop-blur-xl overflow-hidden ${
            isDarkMode 
          ...
          } ${isExpanded ? 'rotate-180 scale-125 shadow-4xl' : 'hover:rotate-45'} ${pulseAnimation ? 'animate-pulse' : ''}`}
        >
          ...
          <div className="relative z-10 transition-transform duration-1000">
            {isExpanded ? (
              <X className="h-10 w-10 group-hover:scale-125 transition-transform drop-shadow-2xl" />
            ) : (
              <Menu className="h-10 w-10 group-hover:scale-125 group-hover:rotate-180 transition-all duration-700 drop-shadow-2xl" />
            )}
          </div>
          
          {/* Professional Glow Effects */}
          <div className="absolute -inset-8 bg-gradient-radial from-blue-400/30 via-purple-400/20 to-transparent rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-1000"></div>
          
          {/* Subtle Orbital Elements */}
          <div className={`absolute -top-3 -right-3 w-4 h-4 bg-blue-500 rounded-full transition-all duration-1000 ${isHovering ? 'animate-bounce' : 'animate-pulse'} border-2 border-white shadow-lg`}></div>
          <div className={`absolute -bottom-3 -left-3 w-3 h-3 bg-purple-500 rounded-full transition-all duration-1000 ${isHovering ? 'animate-ping' : 'animate-pulse'} border border-white shadow-md`}></div>
        </Button>
        ...
        {buttonsData.whatsapp?.enabled && (
          <Button
            ...
            className={`group relative w-24 h-24 rounded-full shadow-3xl transition-all duration-1000 hover:scale-130 border-6 border-white/50 backdrop-blur-xl overflow-hidden ${
              activeButton === 'whatsapp' ? 'scale-125 rotate-6 shadow-4xl' : ''
          ...
          >
            ...
            <WhatsAppIcon className="h-12 w-12 group-hover:scale-130 group-hover:rotate-6 transition-all duration-700 relative z-10 text-white drop-shadow-2xl" />
            
            {/* Professional Glow System */}
            <div className="absolute -inset-8 bg-gradient-radial from-green-400/50 via-green-300/35 to-transparent rounded-full blur-3xl opacity-70 group-hover:opacity-100 transition-opacity duration-1000"></div>
        ...
        {buttonsData.phone?.enabled && (
          <Button
            ...
            className={`group relative w-24 h-24 rounded-full shadow-3xl transition-all duration-1000 hover:scale-130 border-6 border-white/50 backdrop-blur-xl overflow-hidden ${
              activeButton === 'phone' ? 'scale-125 -rotate-6 shadow-4xl' : ''
          ...
          >
            ...
            {/* Professional Call Wave Systems */}
            ...
            <Phone className="h-12 w-12 group-hover:scale-130 group-hover:-rotate-6 transition-all duration-700 relative z-10 text-white drop-shadow-2xl" />
            
            {/* Professional Glow */}
            <div className="absolute -inset-8 bg-gradient-radial from-orange-400/60 via-amber-300/45 to-transparent rounded-full blur-3xl opacity-70 group-hover:opacity-100 transition-opacity duration-1000"></div>
            
            {/* Professional Status Indicators */}
            <div className="absolute -top-2 -left-2 w-6 h-6 bg-green-500 rounded-full animate-pulse border-3 border-white flex items-center justify-center shadow-lg">
              <div className="w-2 h-2 bg-white rounded-full animate-ping"></div>
            </div>
            <div className="absolute -bottom-3 -right-3 w-7 h-7 bg-blue-500 rounded-full border-3 border-white flex items-center justify-center animate-bounce shadow-xl">
        ...
        {showScrollTop && (
          <Button
            ...
            } ${activeButton === 'scroll' ? 'scale-125 -translate-y-3 shadow-3xl' : ''}`}
          >
            ...
            <div className="absolute inset-0 bg-slate-300/20 animate-ping rounded-2xl opacity-0 group-hover:opacity-50"></div>
            ...
            <ChevronUp className="h-9 w-9 group-hover:scale-125 group-hover:-translate-y-2 transition-all duration-500 relative z-10 animate-bounce drop-shadow-lg" />
            <div className="absolute -inset-4 bg-slate-400/30 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
